...
public ResponseEntity<ApiResponse<?>> getEnrollments(
    ...
    UUID currentUserId = UUID.nameUUIDFromBytes(username.getBytes());
    ...
    if ("ROLE_ADMIN".equals(role)) {
        ...
        return ResponseEntity.ok(new ApiResponse<>(HttpStatus.OK.value(), "All enrollments fetched successfully", enrollments)); // ✅ fixed
    }
